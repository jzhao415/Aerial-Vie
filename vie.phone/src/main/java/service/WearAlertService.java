...
import com.example.jeffzhao415.vie.MainActivity;
...
public class WearAlertService extends WearableListenerService {
    ...
    private void triggerAlert() {
        ...
        final String smsNumber = mSharedPrefs.getString(MainActivity.PREF_KEY_SMS_NUMBER, null);
        final String smsMessage = mSharedPrefs.getString(MainActivity.PREF_KEY_SMS_MESSAGE,
                getString(R.string.default_emergency_message));
        boolean sendLocation = mSharedPrefs.getBoolean(MainActivity.PREF_KEY_SMS_MESSAGE_LOCATION,
                true);
        boolean showNotification = mSharedPrefs.getBoolean(MainActivity.PREF_KEY_SHOW_NOTIFICATION,
                true);
